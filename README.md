...
### Why this repo?
I developed these MATLAB functions to assist myself in preparing for the **control-theory exam**, as our professor allowed us to use a laptop during the test. Ultimately, these functions turned out to be very helpful, not only for understanding the subject but also for completing the exam itself.
